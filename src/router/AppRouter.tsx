...
const AccountSecurityPage = lazy(() => import("@/pages/settings/AccountSecurityPage"));
...
const AdminFileManagerPage = lazy(() => import("@/pages/admin/storage/AdminFileManagerPage"));
    ...
    <PlatformModeGuard>
      <Suspense fallback={<RouteLoader />}>
        <Routes>
          ...
          {/* Dedicated Account Security & Credentials routes */}
          ...
          >
            ...
            <Route path="storage" element={<AdminFileManagerPage />} />
            <Route path="file-storage" element={<Navigate to="/platform/admin/storage" replace />} />
