  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="prose prose-sm dark:prose-invert mx-auto max-w-3xl px-4 py-8">
        ...
        <h3>6. Contact</h3>
        <p>For privacy inquiries, email <a href="mailto:atharv@bkbirlanightcollege.qzz.io" className="text-primary hover:underline"><strong>atharv@bkbirlanightcollege.qzz.io</strong></a></p>
      </main>
    </div>
  );
}
