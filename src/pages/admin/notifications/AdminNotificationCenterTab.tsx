...
import { Bell, CalendarClock, Send, Save, RefreshCw } from "lucide-react";
  ...
  const notificationsQuery = useQuery({
    ...
    queryFn: async (): Promise<NotificationRow[]> => {
      const { data, error } = await supabase
        .from("notifications")
        .select(
          "id,title,body,target_role,target_user_id,status,scheduled_for,sent_at,created_at,created_by",
        )
